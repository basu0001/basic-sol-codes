...
contract tokenRecipient {
    ...
    function receiveApproval(address _from, uint256 _value, address _token, bytes memory _extraData) public {
        ...
        require(t.transferFrom(_from, _to, _value));
...
contract Congress is owned, tokenRecipient {
    ...
    constructor (uint minimumQuorumForProposals, uint minutesForDebate, int marginOfVotesForMajority) payable public {
    ...
    function newProposal(address beneficiary, uint weiAmount, string memory jobDescription, bytes memory transactionBytecode) onlyMembers public returns (uint proposalID) {
